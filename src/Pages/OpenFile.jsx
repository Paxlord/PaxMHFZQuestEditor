...
const OpenFile = () => {
  ...
  return(
    <div className="bg-zinc-500 mx-16 bg-opacity-60 backdrop-blur-sm rounded p-4 h-[calc(100vh-8rem)] mt-16 self-center shadow-lg  gap-y-8 text-white flex flex-col justify-center items-center">
      ...
      <button onClick={() => openQuestData()} className="transition px-4 py-2 hover:shadow-md bg-green-500 shadow-sm rounded text-white hover:bg-green-600 active:bg-green-700">Open quest file</button>
    </div>
  );
