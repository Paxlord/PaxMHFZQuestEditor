...
export const QuestToQuestList = ({
  ...
  let stringSignature = [
    0x00, 0x12, 0x83, 0x59, 0x89, 0x5b, 0x83, 0x3a, 0x58, 0xb6, 0x8e, 0x59,
    0x82, 0xcc, 0x83, 0x58, 0x83, 0x58, 0x83, 0x81,
  ];
  ...
  let questListArray = new Uint8Array(
  ...
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.legs.piece_id,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.legs.deco_1,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.legs.deco_2,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.legs.deco_3,
    true
  );
  curOffset += 2;
  ...
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.weapon.piece_id,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.weapon.deco_1,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.weapon.deco_2,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.weapon.deco_3,
    true
  );
  curOffset += 2;
  ...
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.head.piece_id,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.head.deco_1,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.head.deco_2,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.head.deco_3,
    true
  );
  curOffset += 2;
  ...
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.chest.piece_id,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.chest.deco_1,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.chest.deco_2,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.chest.deco_3,
    true
  );
  curOffset += 2;
  ...
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.arms.piece_id,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.arms.deco_1,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.arms.deco_2,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.arms.deco_3,
    true
  );
  curOffset += 2;
  ...
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.waist.piece_id,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.waist.deco_1,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.waist.deco_2,
    true
  );
  curOffset += 2;
  questListDataView.setUint16(
    curOffset,
    equipmentRestrictions.waist.deco_3,
    true
  );
  curOffset += 2;
  ...
  curOffset += 1;
  questListDataView.setUint8(curOffset, flags.quest_flag3 & 0b11011111);
  curOffset += 1;
