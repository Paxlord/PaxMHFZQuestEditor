...
const ListItem = ({itemName, itemId}) => {
  ...
  return(
    <div className="h-12 bg-zinc-500 bg-opacity-60 backdrop-blur-sm rounded py-2 px-2 shadow-lg flex justify-between items-center">
        ...
        <button onClick={() => copyToClipboard(itemId)} className="transition px-4 py-1 hover:shadow-md bg-zinc-500 shadow-sm rounded text-white hover:bg-green-600 active:bg-green-700">Copy</button>
    </div>
  )
}
